...
export const BITRIX_WEBHOOK_IN = process.env.BITRIX_WEBHOOK_IN || 'https://trolley.proxy.rlwy.net';

export const BITRIX_WEBHOOK_OUT = process.env.BITRIX_WEBHOOK_OUT || 'https://trolley.proxy.rlwy.net';